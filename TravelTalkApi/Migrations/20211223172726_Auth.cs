    ...
    public partial class Auth : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryUser", x => new { x.CategoryModCategoryId, x.ModsId });
                    table.ForeignKey(
                        name: "FK_CategoryUser_AspNetUsers_ModsId",
                        column: x => x.ModsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationUser", x => new { x.NotificationsNotificationId, x.ReceiversId });
                    table.ForeignKey(
